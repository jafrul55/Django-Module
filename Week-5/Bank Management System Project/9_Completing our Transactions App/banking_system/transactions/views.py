...
class TransactionRequestView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        if start_date_str and end_date_str:
            ...
            queryset = queryset.filter(timestamp__date__gte=start_date, timestamp__date__lte=end_date).aaggregate(
